...
public class DeploymentManager {
  ...
  private Future<Deployment> doDeploy(String identifier,
    ...
    for (Verticle verticle: verticles) {
      ...
      ContextInternal context = (options.isWorker() ? vertx.createWorkerContext(deployment, closeFuture, workerPool, tccl) :
  ...
  static class VerticleHolder {
    ...
    VerticleHolder(Verticle verticle, ContextInternal context, WorkerPool workerPool, CloseFuture closeFuture) {
  ...
  private class DeploymentImpl implements Deployment {
    ...
    private synchronized void rollback(ContextInternal callingContext, Handler<AsyncResult<Deployment>> completionHandler, ContextInternal context, VerticleHolder closeFuture, Throwable cause) {
    ...
    public synchronized Future<Void> doUndeploy(ContextInternal undeployingContext) {
      ...
      if (!children.isEmpty()) {
        ...
        for (VerticleHolder verticleHolder: verticles) {
          ContextInternal context = verticleHolder.context;
